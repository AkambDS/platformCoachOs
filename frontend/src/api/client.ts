...
export const settingsApi = {
  ...
  getCommunicationTags:   ()                   => api.get('/api/settings/communication-tags/'),
  createCommunicationTag: (d: any)             => api.post('/api/settings/communication-tags/', d),
  updateCommunicationTag: (id: number, d: any) => api.patch(`/api/settings/communication-tags/${id}/`, d),
  deleteCommunicationTag: (id: number)         => api.delete(`/api/settings/communication-tags/${id}/`),
  getLeadSources:       ()                   => api.get('/api/settings/lead-sources/'),
  createLeadSource:     (d: any)             => api.post('/api/settings/lead-sources/', d),
  updateLeadSource:     (id: number, d: any) => api.patch(`/api/settings/lead-sources/${id}/`, d),
  deleteLeadSource:     (id: number)         => api.delete(`/api/settings/lead-sources/${id}/`),
  getAffiliations:      ()                   => api.get('/api/settings/affiliations/'),
