...
const COACH_NAV: NavItem[] = [
  ...
  { to: '/clients',    Icon: Users,             label: 'Clients',    roles: ['business_owner'], tour: 'clients'    },
  ...
  { section: 'Finance', roles: ['business_owner'] },
  { to: '/invoices',   Icon: Receipt,           label: 'Invoices',   roles: ['business_owner'], tour: 'invoices' },
  { section: 'Content' },
