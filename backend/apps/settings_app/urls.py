...
urlpatterns = [
    ...
    path("communication-tags/",       views.communication_tag_configs,        name="settings-communication-tags"),
    path("communication-tags/<int:pk>/", views.communication_tag_config_detail, name="settings-communication-tag-detail"),
    path("lead-sources/",             views.lead_source_configs,              name="settings-lead-sources"),
    path("lead-sources/<int:pk>/",   views.lead_source_config_detail,        name="settings-lead-source-detail"),
